...
module.exports = function (callback) {
    ...
    try {
        ...
        utils.shellExecute('cd ' + utils.projectRoot('Apps/Webiny') + ' && npm install');

        utils.copy(utils.projectRoot('Apps/Webiny/Setup/.'), utils.projectRoot());
        ...
        inquirer.prompt(questions).then(function (answers) {
            ...
            utils.shellExecute('php Apps/Webiny/Php/Cli/install.php Webiny', {stdio: 'pipe'});

            // Create admin user
            var params = [answers.domain, answers.user, answers.password].join(' ');
            try {
                var output = utils.shellExecute('php Apps/Webiny/Php/Cli/admin.php ' + params, {stdio: 'pipe'});
