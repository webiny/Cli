        ...
        try {
            ...
            var questions = [
                {
                    type: 'input',
                    name: 'domain',
                    message: 'What\'s your development domain (e.g. http://domain.app)?',
            ...
            inquirer.prompt(questions).then(function (answers) {
                try {
                    ...
                    config.Application.AbsolutePath = process.env.PWD;
                ...
                try {
                    var output = utils.shellExecute('php vendor/webiny/setup/admin.php ' + params, {stdio: 'pipe'});
                    if (output == 'created') {
