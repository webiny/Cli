...
var configs = {
    ...
    production: {
        ...
        security: utils.projectRoot('Configs/Production/Security.yaml')
    }
};
    ...
    try {
        ...
        inquirer.prompt(questions).then(function (answers) {
            try {
                ...
                // Populate Production/Security.yaml
                config = yaml.safeLoad(utils.readFile(configs.production.security));
                config.Security.Tokens.Webiny.SecurityKey = generatePassword(30, false, /[\dA-Za-z#_\$:\?#]/);
                utils.writeFile(configs.production.security, yaml.safeDump(config, {indent: 4, flowLevel: 5}));
