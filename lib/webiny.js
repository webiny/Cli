...
class Webiny extends Dispatcher {
    constructor() {
        ...
        /**
         * We need to override node module loader to point to webiny-cli which is not located anywhere inside project directory
         */
        const Module = require('module');
        const originalRequire = Module.prototype.require;
        Module.prototype.require = function () {
            if (arguments[0].startsWith('webiny-cli')) {
                return originalRequire.apply(this, [path.dirname(process.mainModule.filename) + path.sep + arguments[0].replace('webiny-cli/', '')]);
            }
