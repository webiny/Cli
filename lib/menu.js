...
module.exports = function () {
    ...
    var appChoices = [
        {name: 'All', value: 'all'},
        {name: 'Last selection', value: 'last'},
    ...
    inquirer.prompt([{
        ...
        validate: function (answer) {
            ...
            if (answer == 'last') {
                config.apps = _.map(lastRun.apps, function (app) {
                    return _.find(apps, {name: app});
                });

                if (!config.apps.length) {
                    return 'The log contains no apps! Please select a different option.';
                }
            }
