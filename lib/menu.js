...
module.exports = function () {
    ...
    inquirer.prompt([{
        ...
        try {
            ...
            switch (task) {
                case 'install-apps':
                    taskProcess = require('./actions/installApps')();
                    break;
                case 'release':
                    taskProcess = require('./actions/release')(config, runner, lastRun);
                    break;
                case 'revert':
                    taskProcess = require('./actions/revert')(config, runner, lastRun);
                    break;
                case 'server-setup':
                    taskProcess = require('./actions/serverHelp')();
                    break;
                case 'run-tests':
                    taskProcess = runner(task, config);
                    break;
                default:
                    taskProcess = runner(task, config);
                    break;
